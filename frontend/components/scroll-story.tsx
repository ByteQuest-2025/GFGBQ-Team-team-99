...
export function ScrollStory() {
  ...
  return (
    <section ref={containerRef} className="relative py-40 px-6">
      <motion.div style={{ opacity, scale }} className="container mx-auto">
        <div className="text-center mb-32">
          <h2 className="text-4xl md:text-7xl font-black tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/40">
            The Integrity <span className="text-primary italic">Pipeline</span>
          </h2>
          <p className="max-w-3xl mx-auto text-xl text-white/50 font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <motion.div
              ...
              className="glass p-8 rounded-[2rem] border-white/5 relative group overflow-hidden"
            >
              <div className="absolute top-4 right-6 text-6xl font-black text-white/5 group-hover:text-primary/10 transition-colors">
                {item.step}
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="flex-1 space-y-12">
            <div className="space-y-6">
              <span className="text-primary font-bold tracking-[0.2em] uppercase text-sm">Scalable Impact</span>
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter leading-tight">
                Designed for the <br /> <span className="italic text-primary">Enterprise Scale.</span>
              </h2>
          ...
          <div className="flex-1 relative w-full aspect-square max-w-lg">
            ...
            <div className="relative h-full w-full glass rounded-[3rem] border-white/10 p-12 overflow-hidden preserve-3d">
              <div className="scanner-overlay" />
              <div className="space-y-8 relative z-10">
                <div className="flex justify-between items-center border-b border-white/5 pb-4">
                  <div className="text-xs font-mono text-white/40">NODE_VERIFICATION_STATUS</div>
                ...
                <div className="pt-4 space-y-4">
                  ...
                  <div className="h-32 rounded-xl bg-black/40 border border-white/5 p-4 font-mono text-[10px] text-primary/60 overflow-hidden leading-relaxed">
