        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4 space-y-12">
            <div className="space-y-6">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-xs font-bold text-red-500 tracking-widest uppercase">
                <Activity className="w-4 h-4" /> Real-time Lab
              </span>
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between p-6 glass rounded-2xl border-white/5">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-sm font-bold tracking-widest text-white/40 uppercase">{item.label}</span>
                  </div>
                  <span className="text-xs font-mono text-primary">{item.val}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-8">
            <div className="relative glass rounded-[3rem] border-white/10 p-1 md:p-12 overflow-hidden aspect-video lg:aspect-auto min-h-[600px] flex flex-col">
              ...
              <div className="flex-1 space-y-12 relative z-10 custom-scrollbar overflow-y-auto px-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold tracking-widest text-primary uppercase">Input detected</span>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <motion.div
                    ...
                    className="p-8 rounded-[2rem] bg-red-500/5 border border-red-500/10 space-y-6"
                  >
                    <div className="flex items-center gap-3">
                  ...
                  <motion.div
                    ...
                    className="p-8 rounded-[2rem] bg-primary/5 border border-primary/10 space-y-6"
                  >
                    <div className="flex items-center gap-3">
                      <Search className="w-4 h-4 text-primary" />
                      <span className="text-xs font-bold tracking-widest text-primary uppercase">Citation Audit</span>
                    </div>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center border-b border-white/5 pb-2">
                        <span className="text-[10px] font-mono text-white/40">NATURE_VOL_42</span>
                        <span className="text-[10px] font-mono text-red-500 tracking-widest font-bold uppercase">
                          NOT_FOUND
                        </span>
                      </div>
                      <div className="flex justify-between items-center border-b border-white/5 pb-2">
                        <span className="text-[10px] font-mono text-white/40">DOI_10.1038_SCI</span>
                        <span className="text-[10px] font-mono text-green-500 tracking-widest font-bold uppercase">
                          VALIDATED
                        </span>
                      </div>
                    </div>
              ...
              <div className="mt-auto pt-12 border-t border-white/5 relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex gap-12">
                  <div className="space-y-1">
                    <div className="text-[10px] font-bold text-white/30 uppercase tracking-widest">Trust Index</div>
                    <div className="text-2xl font-black text-red-500">LOW (12/100)</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-[10px] font-bold text-white/30 uppercase tracking-widest">Mitigation</div>
                    <div className="text-2xl font-black text-white">AUTORUN</div>
                  </div>
                </div>
                <button className="px-8 h-12 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-[10px] font-bold tracking-widest uppercase transition-all">
